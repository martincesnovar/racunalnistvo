...
def _validate_current_file():
    ...
    if Check.part():
        ...
        try:
            Check.equal('razdalja("miza", "muza")', 1)
            Check.equal('razdalja("letnik", "letnica")', 2)
            Check.equal('razdalja("morje", "poletje")', 4)
            Check.equal('razdalja("poletje", "morje")', 4)
            Check.equal('razdalja("morje", "")', 5)
            Check.equal('razdalja("", "poletje")', 7)
            Check.equal('razdalja("", "")', 0)
        except:
    ...
    if Check.part():
        ...
        try:
            Check.equal('spremembe("letnik", "letnica")', [('c/k', 6), ('+a', 7)])
            Check.equal('spremembe("morje", "poletje")', [('p/m', 1), ('l/r', 3), ('+e', 4), ('+t', 5)])
            Check.equal('spremembe("poletje", "morje")', [('m/p', 1), ('r/l', 3), ('-e', 4), ('-t', 4)])
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
