...
def _validate_current_file():
    ...
    if Check.part():
        ...
        try:
            Check.equal("""permutacija_s_skladom([3, 2, 5, 7, 6, 4, 1])""", True)
            Check.equal("""permutacija_s_skladom([2, 5, 4, 7, 6, 3, 1])""", True)
            Check.equal("""permutacija_s_skladom([1, 2, 3, 4, 5, 6, 7])""", True)
            Check.equal("""permutacija_s_skladom([7, 6, 5, 4, 3, 2, 1])""", True)
            Check.equal("""permutacija_s_skladom([7, 1, 2, 3, 4, 5, 6])""", False)
            Check.equal("""permutacija_s_skladom([3, 5, 4, 6, 7, 1, 2])""", False)
            Check.equal("""permutacija_s_skladom([3, 5, 4, 7, 2, 6, 1])""", False)
        except:
