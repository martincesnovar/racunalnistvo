        ...
        try:
            test_data = [
                ...
                (["""s = Sklad()""",
                  ...
                  """x = s.pop()""",
                  """izpis = str(s)"""],
                 {'x': 5, 'izpis': 'DNO : 6 : 1 : 2 : 4 : VRH'}),
                (["""s = Sklad()""",
                  """for i in range(100):""",
                  """    s.vstavi(i)""",
                  """x = s.pop()""",
                  """izpis = str(s)"""],
                 {'x': 99, 'izpis': 'DNO : ' + ' : '.join(str(x) for x in range(99)) + ' : VRH'}),
            ]
            for td in test_data:
                if not Check.run(*td):
                    break
        ...
        try:
            test_data = [
                (["""s = Sklad()""",
                  ...
                  """s.vstavi(3)""",
                  """s.vstavi(1)""",
                  """p = s.prestej_elemente()""",
                  """izpis = str(s)"""],
                 {'p': 3, 'izpis': 'DNO : 6 : 3 : 1 : VRH'}),
                (["""s = Sklad()""",
                  """s.vstavi(6)""",
                  """s.vstavi(1)""",
                  """s.vstavi(2)""",
                  ...
                  """p = s.prestej_elemente()""",
                  """izpis = str(s)"""],
                 {'p': 5, 'izpis': 'DNO : 6 : 1 : 2 : 4 : 5 : VRH'}),
                (["""s = Sklad()""",
                  """for i in range(100):""",
                  """    s.vstavi(i)""",
                  """p = s.prestej_elemente()""",
                  """izpis = str(s)"""],
                 {'p': 100, 'izpis': 'DNO : ' + ' : '.join(str(x) for x in range(100)) + ' : VRH'}),
                (["""s = Sklad()""",
                  """p = s.prestej_elemente()""",
                  """izpis = str(s)"""],
                 {'p': 0, 'izpis': 'DNO : VRH'}),
